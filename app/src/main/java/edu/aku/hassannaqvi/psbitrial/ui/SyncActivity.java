...
import edu.aku.hassannaqvi.psbitrial.adapters.SyncListAdapter;
...
import edu.aku.hassannaqvi.psbitrial.databinding.ActivitySyncBinding;

import edu.aku.hassannaqvi.psbitrial.models.SyncModel;
import edu.aku.hassannaqvi.psbitrial.models.Users;
import edu.aku.hassannaqvi.psbitrial.models.VersionApp;
import edu.aku.hassannaqvi.psbitrial.workers.DataDownWorkerALL;
import edu.aku.hassannaqvi.psbitrial.workers.DataUpWorkerALL;
import edu.aku.hassannaqvi.psbitrial.workers.PhotoUploadWorker2;
...
//Do something with the JSON string
                        if (result != null) {
                            if (result.length() > 0) {
                                ...
                                DatabaseHelper db = new DatabaseHelper(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this);
                                try {
                                ...
                                try {
                                    ...
                                    for (Method method1 : db.getClass().getDeclaredMethods()) {
                                        ...
                                        if (method1.getName().equals("updateSynced" + tableName)) {
                                            method = method1;
                                            Toast.makeText(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this, "updateSynced not found: updateSynced" + tableName, Toast.LENGTH_SHORT).show();
                                            break;
                                        }
                                    }
                                    if (method != null) {
                                        ...
                                        Toast.makeText(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this, tableName + " synced: " + sSynced + "\r\n\r\n Errors: " + sSyncedError, Toast.LENGTH_SHORT).show();
                                    ...
                                    e.printStackTrace();
                                    Toast.makeText(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this, "Sync Result:  " + result, Toast.LENGTH_SHORT).show();
        ...
        if (sdDir.exists()) {
            ...
            if (files.length > 0) {
                ...
                for (int i = 0; i < fcount; i++) {
                    TextView textView = new TextView(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this);
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            WorkManager.getInstance().getWorkInfoByIdLiveData(photoUpload.getId())
                                    .observe(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this, new Observer<WorkInfo>() {
                                        ...
                                        public void onChanged(@Nullable WorkInfo workInfo) {
                                            ...
                                            if (workInfo.getState() == WorkInfo.State.FAILED) {
                                                Toast.makeText(edu.aku.hassannaqvi.psbitrial.ui.SyncActivity.this, "Failed", Toast.LENGTH_SHORT).show();
